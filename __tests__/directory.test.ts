...
describe('Directory Configuration', () => {
  test('should have Let\'s Encrypt staging configuration', () => {
    ...
    expect(directory.letsencrypt.staging.directoryUrl).toBe('https://acme-staging-v02.api.letsencrypt.org/directory');
  ...
  test('should have Let\'s Encrypt production configuration', () => {
    ...
    expect(directory.letsencrypt.production.directoryUrl).toBe('https://acme-v02.api.letsencrypt.org/directory');
